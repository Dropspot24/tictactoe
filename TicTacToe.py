...
def user_input(player):
    ...
    if check_emptyspaces() == True :
        ...
        while type(a) != type('int') :
            try:
                a = int(input("Тоглогч" + "1-ээс 9-ийн хооронд тоо оруулна уу :"))
                if a > 0 and a <= 9 :
                    return a
                else:
    ...
    try:
        ...
        if vs > 0 and vs <=2 :
            ...
            while player1 != 'x' or player1 != 'o':
                ...
                player1 = int(input('Тоглогч 1 дараах сонголтуудаас сонгох X эсвэл O :'))
        ...
        print('Оруулсан утга буруу байна ! Дахин оруулна уу !')
        
turtle.penup()
turtle.goto(0,200)
turtle.pendown()
turtle.write("Тоглосонд баярлалаа !",font=('Arial', 20, 'normal'))
